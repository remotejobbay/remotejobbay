...
export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-12 text-gray-800 leading-relaxed">
      <h1 className="text-4xl font-bold mb-6 text-blue-700">🌍 About RemoteJobBay</h1>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-purple-700">💡 Why RemoteJobBay Was Created</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-purple-700">🚀 What We Offer</h2>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-purple-700">🎯 Our Mission</h2>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-purple-700">🌐 Who It's For</h2>
      <ul className="list-disc list-inside mb-4 space-y-1 text-gray-700">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-purple-700">📢 Stay Connected</h2>
      <p className="mb-4">
      ...
      <div className="mt-10 border-l-4 border-yellow-400 pl-4 text-lg font-semibold text-gray-900">
